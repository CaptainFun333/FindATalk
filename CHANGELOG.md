...
### Added
- Added a "CFM" tab — talks matching this week's "Come, Follow Me" reading, ranked by how closely they match. Use the arrows to browse other weeks. Most weeks match by cited scripture; Easter and Christmas match by topic instead, and the very first week (which introduces the year rather than assigning a scripture) matches talks that reference "Come, Follow Me" itself. Since a 6th tab didn't fit as plain text, the whole tab bar switched to small icons with short labels underneath, matching how most phone apps handle more than four or five tabs.
