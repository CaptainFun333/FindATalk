...
### Added
- Added a "CFM" tab — talks whose cited scriptures overlap this week's "Come, Follow Me" reading, ranked by how closely they match. Use the arrows to browse other weeks; weeks with no scripture assignment (like Easter and Christmas) say so instead of showing an empty list. Since a 6th tab didn't fit as plain text, the whole tab bar switched to small icons with short labels underneath, matching how most phone apps handle more than four or five tabs.
